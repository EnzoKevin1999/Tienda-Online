...
$sql="SELECT * FROM talle WHERE Id='$Id'";
...
<div style="float:right"><a href="cerrarsesion.php">Cerrar Sesion</a></div>
    ...
    <h1 id="txtagregueproducto" style="margin-top:50px;">Actualize su Marca</h1>
...
<form action="actualizartalle.php?Id=<?php echo $Id;?>" method="post" class="formagregar" enctype="multipart/form-data">
...
<div class="form-group">
  ...
  <input type="text" name="talle" id="talle" size="100px" class="form-control" value="<?php echo isset($f["numero"]) ? $f["numero"] : ''; ?>"required>
...
<div class="botones">  <input type="submit" id="enviar" value="Actualizar" name="submit" class="formulario__submit__agregar">
