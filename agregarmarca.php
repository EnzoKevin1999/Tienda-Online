...
<div style="float:right"><a href="cerrarsesion.php">Cerrar Sesion</a></div>
    ...
    <h1 id="txtagregueproducto" style="margin-top:50px;">Agregue una Marca</h1>
...
<form action="procesoagregarmarca.php" method="post" class="formagregar" enctype="multipart/form-data">
...
<div class="form-group">
  ...
  <input type="text" name="marca" id="marca" size="100px" class="form-control" required>
...
<div class="botones">  
  ...
  <input type="submit" id="enviar" value="Agregar Marca" name="submit" class="formulario__submit__agregar">



<a href="modificarmarca.php" id="btnmodificar">Modificar Marca</a></div>
