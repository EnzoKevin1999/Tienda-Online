...
<div style="float:right"><a href="cerrarsesion.php">Cerrar Sesion</a></div>
    ...
    <h1 id="txtagregueproducto" style="margin-top:50px;">Actualize su Color</h1>
...
<form action="actualizarcolor.php?Id=<?php echo $Id;?>" method="post" class="formagregar" enctype="multipart/form-data">
...
<div class="form-group">
  ...
  <input type="text" name="colores" id="colores" size="100px" class="form-control" value="<?php echo isset($f["nombre"]) ? $f["nombre"] : ''; ?>"required>
