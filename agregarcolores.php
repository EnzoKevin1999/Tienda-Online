...
<header>
    ...
    <h1 id="txtagregueproducto" style="margin-top:50px;">Agregue un Color</h1>
...
<form action="procesoagregarcolores.php" method="post" class="formagregar" enctype="multipart/form-data">
...
<div class="form-group">
  ...
  <input type="text" name="colores" id="colores" size="100px" class="form-control" required>
