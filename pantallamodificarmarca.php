...
<form action="actualizarmarca.php?Id=<?php echo $Id;?>" method="post" class="formagregar" enctype="multipart/form-data">
...
<div class="form-group">
  ...
  <input type="text" name="marca" id="marca" size="100px" class="form-control" value="<?php echo isset($f["nombre"]) ? $f["nombre"] : ''; ?>"required>
